    ...
    <Foot>
      ...
      <Trending>
        <div>
          ...
          <p>
            ‘Liger’ Movie Review: Vijay Deverakonda’s Action Drama Is All
            Noise...
          </p>
          <p>
            Former ISRO Colleagues Challenge Claims About Nambi Narayanan’s
            Rol...
          </p>
          <p>
            For The First Time, India Votes Against Russia In UNSC During
            Proce...
          </p>
          <p>
            Adani Stake In NDTV | Company Says SEBI Order Restrained Prannoy,
            R...
          </p>
          <p>
            Adani Stake In NDTV | Two Oligarchs Taking Over Entire Media, Sa...
          </p>
        </div>
        <div>
          <h3>TENDING TOPIC</h3>
